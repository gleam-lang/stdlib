...
/// Take two functions and chains them together to form one function that takes
...
/// Take a function with arity two
...
/// Take a function with arity three
/// and returns a curried equivalent.
...
/// Take a function that takes two arguments and returns a new function that
