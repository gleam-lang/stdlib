...
pub fn parse_ftp_scheme_test() {
  assert "ftp://user001:password@private.ftp-server.example.com/my_directory/my_file.txt"
    |> uri.parse
    == Ok(uri.Uri(
      scheme: Some("ftp"),
...
pub fn parse_sftp_scheme_test() {
  assert "sftp://user001:password@private.ftp-server.example.com/my_directory/my_file.txt"
    |> uri.parse
    == Ok(uri.Uri(
      scheme: Some("sftp"),
      host: Some("private.ftp-server.example.com"),
...
pub fn parse_tftp_scheme_test() {
  assert "tftp://user001:password@private.ftp-server.example.com/my_directory/my_file.txt"
    |> uri.parse
    == Ok(uri.Uri(
      scheme: Some("tftp"),
      host: Some("private.ftp-server.example.com"),
...
pub fn parse_ldap_scheme_test() {
  assert "ldap:///dc=example,dc=com??sub?(givenName=John)"
    |> uri.parse
    == Ok(uri.Uri(
      scheme: Some("ldap"),
      host: Some(""),
...
pub fn parse_ldap_2_scheme_test() {
  assert "ldap://ldap.example.com/cn=John%20Doe,dc=foo,dc=com"
    |> uri.parse
    == Ok(uri.Uri(
      scheme: Some("ldap"),
...
pub fn path_only_uri_to_string_test() {
  assert uri.Uri(None, None, None, None, "/", None, None)
    |> uri.to_string
    == "/"

  assert uri.Uri(None, None, None, None, "/teapot", None, None)
    |> uri.to_string
    == "/teapot"

  assert uri.Uri(None, Some("user"), None, None, "/teapot", None, None)
    |> uri.to_string
    == "/teapot"
...
pub fn scheme_to_string_test() {
  assert uri.Uri(Some("ftp"), None, None, None, "thing.txt", None, None)
    |> uri.to_string
    == "ftp:thing.txt"

  assert uri.Uri(Some("ftp"), None, None, None, "", None, None)
    |> uri.to_string
    == "ftp:"

  assert uri.Uri(Some("ftp"), Some("ignored"), None, None, "", None, None)
    |> uri.to_string
    == "ftp:"

  assert uri.Uri(Some("https"), None, None, None, "/one/two", None, None)
    |> uri.to_string
    == "https:/one/two"

  assert uri.Uri(None, None, None, None, "noslash", None, Some("frag"))
    |> uri.to_string
    == "noslash#frag"
}

pub fn host_to_string_test() {
  assert uri.Uri(Some("ftp"), None, Some("example.com"), None, "", None, None)
    |> uri.to_string
    == "ftp://example.com/"

  assert uri.Uri(None, None, Some("example.com"), None, "", None, None)
    |> uri.to_string
    == "//example.com/"

  assert uri.Uri(None, None, Some("example.com"), None, "/slash", None, None)
    |> uri.to_string
    == "//example.com/slash"

  assert uri.Uri(None, None, Some("example.com"), None, "noslash", None, None)
    |> uri.to_string
    == "//example.com/noslash"

  assert uri.Uri(None, None, Some(""), None, "", None, None)
    |> uri.to_string
    == "//"
  ...
  assert uri.Uri(None, None, Some(""), None, "", None, Some("ok"))
    |> uri.to_string
    == "//#ok"
}
...
pub fn port_to_string_test() {
  ...
  assert uri.Uri(None, None, Some("example.com"), Some(40), "", None, None)
    |> uri.to_string
    == "//example.com:40/"
  ...
  assert uri.Uri(None, None, None, Some(81), "noslash", None, None)
    |> uri.to_string
    == "noslash"
}
